...
if split_type == "id":
    ...
    DirUtils.split_dir_of_dir(output_dir, train_dir=train_dir, val_dir=val_dir + "_val", test_size=test_size, remove_in_dir=True)
    DirUtils.split_dir_of_dir(val_dir + "_val", train_dir=val_dir, val_dir=test_dir, test_size=0.5, remove_in_dir=True)
else:
    raise ValueError()
